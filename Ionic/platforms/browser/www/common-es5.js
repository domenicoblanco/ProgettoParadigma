...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesUsersUsersServiceTs(module, __webpack_exports__, __webpack_require__) {
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    return _context3.abrupt("return", this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_URL, "/users"), user, this.httpOptions).toPromise());
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    return _context4.abrupt("return", this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_URL, "/users")).toPromise());
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    ...
                    return _context5.abrupt("return", this.http.put("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_URL, "/users/").concat(user._id), user, {
            ...
            return regeneratorRuntime.wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    headerOptions = this.httpOptions.headers.append('Authorization', "Bearer ".concat(this.auth.userToken));
                    return _context6.abrupt("return", this.http["delete"]("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_URL, "/users/").concat(userId), {
                      headers: headerOptions
                    }).toPromise());
    ...
    UsersService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _auth_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]])], UsersService);
    /***/
  }
}]);
